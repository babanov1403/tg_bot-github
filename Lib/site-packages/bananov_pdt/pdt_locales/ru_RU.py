...
Weekdays_babanov = ['понедельник', 'вторник', 'среду', 'четверг', 'пятницу', 'субботу', 'воскресенье']
...
units = {
    'seconds': ['секунда', 'секунды', 'секунд', 'сек', 'с', 'секунду'],
    'minutes': ['минута', 'минуты', 'минут', 'мин', 'м', 'минуту'],
    'hours': ['час', 'часа', 'часов', 'ч'],
    'days': ['день', 'дня', 'дней','д'],
    'weeks': ['неделя', 'недели', 'н', 'неделю', 'недель', 'неделе'],
