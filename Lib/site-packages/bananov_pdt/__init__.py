        ...
        if unit in self.ptc.units['months']:
            ...
            if unit:
                ...
                if subctx.hasDate:  # working with dates
                    ...
                    elif u in self.ptc.Weekdays or u in self.ptc.Weekdays_babanov:
...
class Constants(object):
    ...
    def __init__(self, localeID=None, usePyICU=True,
        ...
        if self.locale is not None:
            ...
            wds_babanov = _getLocaleDataAdjusted(self.locale.Weekdays_babanov)
            ...
            self.locale.re_values['babanov'] = re_join(wds_babanov)
            ...
            _buildOffsets(self.locale.WeekdayOffsets,
                          self.locale.Weekdays_babanov, 0)
            _buildOffsets(self.locale.WeekdayOffsets,
